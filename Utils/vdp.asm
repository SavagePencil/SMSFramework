...
; If you want to define a nametable entry with all of the parameters.
.MACRO DEFINE_NAMETABLE_ENTRY ARGS PATTERN_INDEX0_511, HFLIP0_1, VFLIP0_1, PALETTE0_1, PRIORITY0_1, USER_FLAGS0_7
;.DW PATTERN_INDEX0_511 | (HFLIP0_1 << (8 + VDP_NAMETABLE_ENTRY_HFLIP_SHIFT)) | (VFLIP0_1 << (8 + VDP_NAMETABLE_ENTRY_VFLIP_SHIFT)) | (PALETTE0_1 << (8 + VDP_NAMETABLE_ENTRY_PALSELECT_SHIFT)) | (PRIORITY0_1 << (8 + VDP_NAMETABLE_ENTRY_PRIORITYSELECT_SHIFT)) | (USER_FLAGS0_7 << (8 + VDP_NAMETABLE_USERBITS_SHIFT)) 
.DSTRUCT INSTANCEOF sNameTableEntry VALUES
    TileIndex .DB <PATTERN_INDEX0_511
    Flags     .DB ((PATTERN_INDEX0_511 >> 8) << VDP_NAMETABLE_ENTRY_BANKSELECT_SHIFT) | (HFLIP0_1 << VDP_NAMETABLE_ENTRY_HFLIP_SHIFT) | (VFLIP0_1 << VDP_NAMETABLE_ENTRY_VFLIP_SHIFT) | (PALETTE0_1 << VDP_NAMETABLE_ENTRY_PALSELECT_SHIFT) | (PRIORITY0_1 << VDP_NAMETABLE_ENTRY_PRIORITYSELECT_SHIFT) | (USER_FLAGS0_7 << VDP_NAMETABLE_USERBITS_SHIFT) 
.ENDST
.ENDM

; If you want to define a nametable location based on row and column.
.MACRO DEFINE_NAMETABLE_LOC ARGS NAME, COL, ROW
    .DEFINE \1 ( VDP_NAMETABLE_START_LOC + ( ROW * VDP_NAMETABLE_ROWSIZE_IN_BYTES ) + ( COL * _sizeof_sNameTableEntry ) )
.ENDM
